...
class DecisionEngineTest {
    ...
    void setUp() {
        ...
        underAgePersonalCode = ""; //Insert underage person's personal ID code
    }

    @Test
    void testUnderAgePersonalCode() {
        assertThrows(UnderagePersonalCodeException.class,
    ...
    void testSegment1PersonalCode() throws InvalidLoanPeriodException, NoValidLoanException,
            InvalidPersonalCodeException, InvalidLoanAmountException, UnderagePersonalCodeException {
